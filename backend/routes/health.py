...
async def root():
    ...
    return {"message": "VideoGen Studio API", "version": __version__}
...
async def filesystem_health():
    ...
    dirs_to_check = {
        "projects": config.get_projects_dir(),
        "renders": config.get_renders_dir(),
