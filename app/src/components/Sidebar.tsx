...
import { Box, Clapperboard, type LucideIcon, LayoutDashboard, Mic, Settings, Volume2 } from 'lucide-react';
...
const tabs: Array<{
  ...
  { id: 'projects', path: '/projects', icon: Clapperboard, label: 'Projects' },
  { id: 'voice', path: '/voice', icon: Volume2, labelKey: 'nav.generate' },
...
export function Sidebar({ isMacOS }: SidebarProps) {
  ...
  return (
    ...
    >
      {/* Logo */}
      <div className="mb-2">
        <img src={videogenLogo} alt="VideoGen Studio" className="sidebar-logo w-auto h-10 object-contain" />
      </div>
