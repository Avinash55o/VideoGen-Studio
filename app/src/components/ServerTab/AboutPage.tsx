    ...
    <>
      ...
      <div className="max-w-md mx-auto h-full flex items-center">
        <div className="flex flex-col items-center text-center space-y-5">
          <FadeIn delay={0}>
            <img src={videogenLogo} alt="VideoGen Studio" className="w-auto h-20 object-contain" />
          </FadeIn>

          <FadeIn delay={80}>
            <div className="space-y-1.5">
              <h1 className="text-lg font-semibold">VideoGen Studio</h1>
          ...
          <FadeIn delay={240}>
            <div className="flex items-center gap-1.5 text-sm text-muted-foreground">
              ...
              <a
                href="https://github.com/Avinash55o"
                target="_blank"
          ...
          <FadeIn delay={320}>
            <div className="flex flex-wrap justify-center gap-3 pt-2">
              <a
                href="https://ko-fi.com/avinashworks"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                <svg
                  className="h-4 w-4 text-[#FF5E5B]"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  aria-hidden="true"
                >
                  <path d="M23.881 8.948c-.773-4.085-4.859-4.593-4.859-4.593H.723c-.604 0-.679.798-.679.798s-.082 7.324-.022 11.822c.164 2.424 2.586 2.672 2.586 2.672s8.267-.023 11.966-.049c2.438-.426 2.683-2.566 2.658-3.734 4.352.24 7.422-2.831 6.649-6.916zm-11.062 3.511c-1.246 1.453-4.011 3.976-4.011 3.976s-.121.119-.31.023c-.076-.04-.272-.196-.272-.196l-2.34-2.391c-1.273-1.316-.953-2.242.279-3.513 1.226-1.28 2.957-1.32 3.717-.579.368.363.874.957 1.183 1.233.358-.271 1.088-.749 1.519-1.047 1.191-.826 2.456-1.284 3.248.033.819 1.36.229 2.875-1.013 4.16z" />
                </svg>
                Buy me a coffee
              ...
              <Trans
                ...
                components={{
                  link: (
                    ...
                    <a
                      href="https://github.com/Avinash55o/VideoGen-Studio/blob/main/LICENSE"
                      target="_blank"
                      rel="noopener noreferrer"
